...
### HTML: 
nos da la estructura de la información. Es un lenguaje para anotar pedazos de información para que el navegador o otros tipos de programa puedan interpretar que tipo de información se encuentra ahí.

[**Web Scraping**](https://en.wikipedia.org/wiki/Web_scraping "Web Scraping")

### CSS:
 nos permite darle colores, arreglar el texto y añadir diferentes elementos de presentación.

### Javascript: 
nos permite añadir interactividad y cómputo a nuestra web.
...
### JSON: 
Simplemente es una forma de transmitir datos entre servidores y clientes. Es la forma estándar en las que en la web y las aplicaciones se comunican con los servidores backend.
